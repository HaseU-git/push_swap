...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/26 14:46:16 by yhasegaw          #+#    #+#             */
/*   Updated: 2021/12/26 14:46:17 by yhasegaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rule_sort_five_b(t_node *list_a, t_node *list_b, t_prs *process)
{
	...
	if (index < 3)
		...
		r_rotate_bn(list_a, list_b, process, 5 - index);
...
void	rule_sort_four_b(t_node *list_a, t_node *list_b, t_prs *process)
{
	...
	if (index < 2)
		...
		r_rotate_bn(list_a, list_b, process, 4 - index);
	push_a(list_a, list_b, process);
